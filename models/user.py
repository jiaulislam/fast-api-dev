...
class User(SQLModel, table=True):
    ...
    username: str = Field(nullable=False, min_length=3, max_length=16, regex="^[a-zA-Z0-9_]*$")
    full_name: str = Field(nullable=False, min_length=3, max_length=50)
    mobile: Optional[str] = Field(nullable=True, min_length=11, max_length=11, regex="^017|016|013|018|019|[0-9]{8}$")
